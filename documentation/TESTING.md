...
it("should handle allocation tool-call exhaustion", async () => {
  // ... callOpenAIParsed setup for classify / ef-debt / amount / timeline / risk ...
