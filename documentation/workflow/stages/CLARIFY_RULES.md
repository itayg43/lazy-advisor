...
> **Rule numbering note (Phase 3 refactor):** Old rules #2 ("Vague timeline") and #10 ("Rich initial goal") were removed. All subsequent rule numbers shifted down by 2. Risk tolerance rules (formerly #10–15) moved to [`clarify.risk.rules.md`](../../../src/server/pipeline/stages/clarify/risk/clarify.risk.rules.md). See git log for prior numbering if needed.
