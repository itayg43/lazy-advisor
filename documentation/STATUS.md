...
4. **Phase 7 — intake cleanup** — drop the `contradictory` handler (delete its `intake/contradictory/` subfolder); update out-of-scope + unrealistic prompts; add clean-goal extraction (7d). Can run in parallel with 5a/5b.
