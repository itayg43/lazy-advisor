...
Conversation: User wants to invest ₪55,000, is 28, says "a 20% drop would stress me but I wouldn't sell" (→ ${RiskTolerance.enum.moderate}: stressed but holds), plans to invest for about 20 years, Israel-based, has emergency fund, no debt, ₪1,800/month. When asked about portfolio defaults, user said: "70% FTSE All-World and 30% TLV-125. קרן כספית is fine."
Output:
- goal: "invest ₪55,000, moderate risk, 20-year horizon with ₪1,800/month contributions"
- amount: 55000
- age: 28
...
Conversation: User wants to invest ₪100,000, is 31, moderate risk, 15-year horizon, has emergency fund, no debt, ₪2,500/month. Wants S&P 500 and TLV-125, confirmed 60/40 split when asked.
Output:
...
Conversation: User has ₪25,000, is 26, aggressive risk, 15-year horizon, has emergency fund held separately outside the portfolio, no debt, ₪500/month. When asked about portfolio defaults, user said: "100% S&P 500. No buffer — my emergency fund is already in a קרן כספית outside this portfolio."
Output:
