...
- **plansToContribute**: \`true\` if the user confirmed they plan to add money to their portfolio periodically, \`false\` otherwise.

# Examples

## Example 1 — moderate risk, portfolio defaults answered with custom split
Conversation: User wants to invest ₪55,000, is 28, says "a 20% drop would stress me but I wouldn't sell" (→ ${RiskTolerance.enum.moderate}: stressed but holds), plans to invest for about 20 years, Israel-based, has emergency fund, no debt, plans to contribute periodically. When asked about portfolio defaults, user said: "70% FTSE All-World and 30% TLV-125. קרן כספית is fine."
Output:
- goal: "invest ₪55,000, moderate risk, 20-year horizon, plans to add money periodically"
- amount: 55000
- age: 28
...
## Example 2 — aggressive risk, goal captures constraints
Conversation: User has ₪180,000 inheritance, is 35, says "I'm comfortable with large swings — a 30% drop wouldn't stress me, I wouldn't do anything differently", investing until retirement at 65 (30-year horizon), no emergency fund, has student debt, does not plan to contribute periodically. When asked about portfolio defaults, user said: "80% MSCI World and 20% TLV-125. קרן כספית for the buffer."
Output:
- goal: "invest ₪180,000 inheritance aggressively until retirement at 65, has student debt and no emergency fund, lump sum only"
- amount: 180000
- age: 35
...
Conversation: User wants to invest ₪100,000, is 31, moderate risk, 15-year horizon, has emergency fund, no debt, plans to contribute periodically. Wants S&P 500 and TLV-125, confirmed 60/40 split when asked.
Output:
...
Conversation: User has ₪25,000, is 26, aggressive risk, 15-year horizon, has emergency fund held separately outside the portfolio, no debt, plans to contribute periodically. When asked about portfolio defaults, user said: "100% S&P 500. No buffer — my emergency fund is already in a קרן כספית outside this portfolio."
Output:
