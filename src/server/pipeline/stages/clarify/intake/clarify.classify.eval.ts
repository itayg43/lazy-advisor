...
describe("classifyGoal", () => {
  ...
  // CLARIFY_RULES #9: unrealistic return expectations are redirected before field collection.
  ...
  // CLARIFY_RULES #3: contradictory risk signals in the goal are resolved before field collection.
